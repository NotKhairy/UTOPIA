...
public class TitanRegistry implements Cloneable // For storing the titan's information from the csv file read in the data loader
{
	...
	public TitanRegistry clone() {
		TitanRegistry clone = new TitanRegistry(code,baseHealth,baseDamage,heightInMeters,speed,resourcesValue,dangerLevel);
		return clone;
	}
